...
def _commands() -> tuple[CommandDef, ...]:
    return (
        ...
        CommandDef("matter-health", "Authoritative matter completion and blocker report.", read_only_safe=True),
        ...
        CommandDef("next-action", "Show the next safe action for an incomplete matter.", read_only_safe=True),
        ...
        CommandDef("runbook", "Export a matter operator runbook with blockers and resume command.", read_only_safe=True),
