...
def _commands() -> tuple[CommandDef, ...]:
    return (
        ...
        CommandDef("memory", "List, show, reject, or mark stale typed legal memory.", supports_dry_run=True),
        ...
        CommandDef("run-free-loop", "Run bounded autonomous supervisor ticks.", requires_live=False),
