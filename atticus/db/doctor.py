...
REQUIRED_COLUMNS: dict[str, frozenset[str]] = {
    ...
    "matter_completion_snapshots": frozenset(
        {
            "snapshot_id",
            "matter_scope",
            "done",
            "safe_to_finalize",
            "blocked",
            "primary_next_action_json",
            "counts_json",
            "report_json",
            "created_at",
        }
    ),
    "final_gate_states": frozenset({"matter_scope", "state", "blocker_json", "next_action_json", "updated_at"}),
    "provider_health_checks": frozenset(
        {
            "provider_health_check_id",
            "matter_scope",
            "provider_policy_fingerprint",
            "requested_provider",
            "requested_model",
    ...
    "authority_verifications": frozenset(
        {
