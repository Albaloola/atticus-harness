...
- `LOCAL_PATH_REDACTED/.openclaw/workspace-atticus-legal`

Archive already created:

- `LOCAL_PATH_REDACTED/archives/atticus_legal_20260425T155713Z/workspace-atticus-legal.tar.gz`
- `LOCAL_PATH_REDACTED/archives/atticus_legal_20260425T155713Z/manifest.sha256`
- `LOCAL_PATH_REDACTED/archives/atticus_legal_20260425T155713Z/run_status.json`
- `LOCAL_PATH_REDACTED/archives/atticus_legal_20260425T155713Z/ledger.sqlite`

New standalone project root:

- `LOCAL_PATH_REDACTED/atticus-harness`

Use `LOCAL_PATH_REDACTED/atticus-harness` as the implementation repo. Treat the old workspace and archive as reference/candidate import material only.
...
1. Legal memory system
   - Answers User's case questions without rerunning the harness.
...
Create or refine a clean Python package under `LOCAL_PATH_REDACTED/atticus-harness`.
