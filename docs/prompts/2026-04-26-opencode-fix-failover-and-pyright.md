...
Repo: `/home/alba/atticus-harness`

You are working on Omar's Atticus legal harness. This is safety-sensitive legal automation. Do not run live OpenRouter calls, do not launch OpenClaw workers, do not enable cron jobs, and do not start live legal work. Use only unit tests, mocked provider responses, and local CLI smoke tests.
...
### A. Fix failover behavior to match Omar's exact requested semantics
...
Omar requested different behavior:
