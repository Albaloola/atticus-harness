...
You are Codex working in `/home/alba/atticus-harness`.
...
```bash
cd /home/alba/atticus-harness && codex exec --full-auto "$(cat docs/prompts/2026-04-26-codex-atticus-safety-hardening.md)"
```

If using a background/long-running Codex invocation, also write the final message to a file:

```bash
cd /home/alba/atticus-harness && codex exec --full-auto --output-last-message codex-last-message.md "$(cat docs/prompts/2026-04-26-codex-atticus-safety-hardening.md)"
```
